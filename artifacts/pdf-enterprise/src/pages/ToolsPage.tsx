              ...
              {activeTool === "unlock" && (
                <Section>
                  <div style={{ background: "#052e16", border: "1px solid #166534", borderRadius: 8, padding: "10px 14px", fontSize: 13, color: "#4ade80", lineHeight: 1.5 }}>
                    🔓 <strong>Auto-Bypass:</strong> Automatically strips PDF password protection — no password required. Upload your PDF and click Unlock PDF to download an unrestricted copy.
                  </div>
                </Section>
              )}
