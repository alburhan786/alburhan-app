...
const DLT_FIELDS: DltField[] = [
  ...
  { key: "orientation_invitation_tid",  label: "17. Orientation Programme Invitation", event: "orientation_invitation",  senderKey: "orientation_invitation_sender" },
  { key: "booking_update_tid",          label: "18. Booking Update (Admin Manual Send)", event: "booking_update",         senderKey: "booking_update_sender" },
