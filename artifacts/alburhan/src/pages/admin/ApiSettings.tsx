...
const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    extraFields: [
      ...
      { key: "arrival_reminder_tid",   label: "11. Arrival Reminder Template ID", placeholder: "Fast2SMS approved template ID", isExtra: true },
      { key: "eid_greeting_tid",       label: "12. Eid Greeting Template ID",     placeholder: "Fast2SMS approved template ID", isExtra: true },
    ],
    testMessageFields: [
