...
const GROUP_COLORS: Record<string, string> = {
  A: "#22c55e", B: "#2563EB", C: "#D97706", D: "#DC2626",
};
...
function SnowflakeSVG({ size = 120, color = "#22c55e", opacity = 0.12 }: { size?: number; color?: string; opacity?: number }) {
                    ...
                    <div key={p.id} className="sq-sticker">
                      <div style={{ position: "relative", overflow: "hidden", height: "100%", display: "flex", flexDirection: "column" }}>
                        ...
                        <div style={{ position: "relative", zIndex: 1, padding: "2mm 3.5mm 1mm", display: "flex", alignItems: "center", gap: "2mm" }}>
                          ...
                          <div style={{ flex: 1 }}>
                            <div style={{ fontWeight: 900, fontSize: "8pt", color: "#22c55e", letterSpacing: "0.8px", textTransform: "uppercase", lineHeight: 1.1 }}>{company.nameShort}</div>
