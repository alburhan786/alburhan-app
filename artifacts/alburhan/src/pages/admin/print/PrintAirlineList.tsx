  ...
  return (
    <>
      ...
      <div className="no-print" style={{ padding: "16px", background: "#fef3c7", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", flexWrap: "wrap" }}>
        ...
        <button onClick={() => window.print()} style={{ padding: "10px 24px", background: "#16a34a", color: "#fff", border: "none", borderRadius: "8px", fontWeight: 600, cursor: "pointer" }}>🖨 Print</button>
        <button onClick={() => window.history.back()} style={{ padding: "10px 24px", border: "1px solid #ccc", borderRadius: "8px", cursor: "pointer", background: "#fff" }}>Back</button>
      </div>

      <div ref={contentRef}>
        <div style={{ padding: "4mm", fontFamily: "'Inter', Arial, sans-serif" }}>
          <PrintHeader title="Airline Passenger Manifest" subtitle={`${group.groupName} (${group.year})`} company={company} />
            ...
            <tbody>
              {pilgrims.map((p, i) => (
                <tr key={p.id} style={{ background: i % 2 === 0 ? "#fff" : "#f0f4fa" }}>
                  ...
                  <td style={{ ...tdStyle, textAlign: "center", fontWeight: 700, color: "#16a34a" }}>{p.busNumber || "—"}</td>
