...
const MODULES: { section: string; color: string; items: Module[] }[] = [
  ...
  // ── 2. Dashboards & BI ──────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Executive Dash",    sub: "KPIs & executive view",   icon: Monitor,        href: "/admin/executive",            kpiKey: "totalRevenue",   kpiLabel: "revenue",   color: "bg-blue-100",    textColor: "text-blue-700",    borderHover: "hover:border-blue-400" },
      { label: "Operations Dash",   sub: "Day-to-day operations",   icon: Activity,       href: "/admin/operations",           kpiKey: "pendingPayments",kpiLabel: "pending",   color: "bg-sky-100",     textColor: "text-sky-700",     borderHover: "hover:border-sky-400" },
      ...
      { label: "Customer Dash",     sub: "Customer-facing portal",  icon: Users2,         href: "/admin/customer-dashboard",   kpiKey: "customers",      kpiLabel: "customers", color: "bg-fuchsia-100", textColor: "text-fuchsia-700", borderHover: "hover:border-fuchsia-400" },
      { label: "Business Intel",    sub: "Trends & insights",       icon: PieChart,       href: "/admin/bi",                   kpiKey: "biCount",        kpiLabel: "metrics",   color: "bg-rose-100",    textColor: "text-rose-700",    borderHover: "hover:border-rose-400" },
    ],
  },
  // ── 3. Finance & Accounting ─────────────────────────────────────────────────
  {
    ...
    items: [
      { label: "Finance Hub",       sub: "P&L, cash flow, ledger",  icon: IndianRupee,    href: "/admin/finance",              kpiKey: "totalRevenue",   kpiLabel: "revenue",   color: "bg-emerald-100", textColor: "text-emerald-700", borderHover: "hover:border-emerald-400" },
      { label: "Accounting",        sub: "Books & journal entries",  icon: Calculator,     href: "/admin/accounting",           kpiKey: "pendingPayments",kpiLabel: "pending",   color: "bg-green-100",   textColor: "text-green-700",   borderHover: "hover:border-green-400" },
      ...
      { label: "Invoices",          sub: "Invoice management",       icon: BookOpen,       href: "/admin/invoices",             kpiKey: "invoices",       kpiLabel: "invoices",  color: "bg-cyan-100",    textColor: "text-cyan-700",    borderHover: "hover:border-cyan-400" },
      { label: "Receipts",          sub: "Payment receipts",         icon: Receipt,        href: "/admin/receipts",             kpiKey: "receipts",       kpiLabel: "receipts",  color: "bg-sky-100",     textColor: "text-sky-700",     borderHover: "hover:border-sky-400" },
  ...
  // ── 4. CRM, Sales & Loyalty ─────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Supplier Manager",  sub: "Supplier directory",       icon: Truck,          href: "/admin/suppliers",            kpiKey: "suppliers",      kpiLabel: "suppliers", color: "bg-fuchsia-100", textColor: "text-fuchsia-700", borderHover: "hover:border-fuchsia-400" },
      { label: "Marketing Center",  sub: "Campaigns & broadcasts",   icon: Megaphone,      href: "/admin/marketing",            kpiKey: "broadcasts",     kpiLabel: "campaigns", color: "bg-rose-100",    textColor: "text-rose-700",    borderHover: "hover:border-rose-400" },
    ],
  },
  // ── 5. HR & Workforce ───────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Payroll Manager",   sub: "Salary & payslips",        icon: IndianRupee,    href: "/admin/payroll",              kpiKey: "staff",          kpiLabel: "staff",     color: "bg-yellow-100",  textColor: "text-yellow-700",  borderHover: "hover:border-yellow-400" },
      { label: "Inventory",         sub: "Stock & equipment",        icon: Package,        href: "/admin/inventory",            kpiKey: "assets",         kpiLabel: "items",     color: "bg-lime-100",    textColor: "text-lime-700",    borderHover: "hover:border-lime-400" },
      { label: "Procurement",       sub: "Purchase orders",          icon: ShoppingCart,   href: "/admin/procurement",          kpiKey: "expenses",       kpiLabel: "orders",    color: "bg-green-100",   textColor: "text-green-700",   borderHover: "hover:border-green-400" },
    ],
  },
  // ── 6. Bookings & Pilgrim Operations ────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Hajj Groups",       sub: "Group management",         icon: Users,          href: "/admin/groups",               kpiKey: "groups",         kpiLabel: "groups",    color: "bg-fuchsia-100", textColor: "text-fuchsia-700", borderHover: "hover:border-fuchsia-400" },
      { label: "Visa Tracker",      sub: "Visa status & processing", icon: FileCheck,      href: "/admin/visa",                 kpiKey: "pendingVisas",   kpiLabel: "pending",   color: "bg-purple-100",  textColor: "text-purple-700",  borderHover: "hover:border-purple-400" },
      { label: "Flight Tickets",    sub: "Flight management",        icon: Plane,          href: "/admin/flights",              kpiKey: "flights",        kpiLabel: "flights",   color: "bg-violet-100",  textColor: "text-violet-700",  borderHover: "hover:border-violet-400" },
      { label: "Hotels",            sub: "Hotel management",         icon: Hotel,          href: "/admin/hotels",               kpiKey: "hotels",         kpiLabel: "hotels",    color: "bg-blue-100",    textColor: "text-blue-700",    borderHover: "hover:border-blue-400" },
      { label: "Transport & Buses", sub: "Buses & vehicles",         icon: Bus,            href: "/admin/buses",                kpiKey: "buses",          kpiLabel: "vehicles",  color: "bg-sky-100",     textColor: "text-sky-700",     borderHover: "hover:border-sky-400" },
      { label: "Room Allocation",   sub: "Mina / Arafat / Muzd.",    icon: Tent,           href: "/admin/allocations",          kpiKey: "allocations",    kpiLabel: "allocated", color: "bg-indigo-100",  textColor: "text-indigo-700",  borderHover: "hover:border-indigo-400" },
      ...
      { label: "Agreements",        sub: "Contracts & digital sign", icon: Scale,          href: "/admin/agreements",           kpiKey: "agreements",     kpiLabel: "agreements",color: "bg-rose-100",    textColor: "text-rose-700",    borderHover: "hover:border-rose-400" },
      { label: "Documents",         sub: "Passport, Aadhaar & docs", icon: FileText,       href: "/admin/document-expiry",      kpiKey: "documents",      kpiLabel: "docs",      color: "bg-pink-100",    textColor: "text-pink-700",    borderHover: "hover:border-pink-400" },
    ],
  },
  // ── 7. Communication & Automation ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "SMS Center",        sub: "DLT & SMS campaigns",      icon: Smartphone,     href: "/admin/sms-production-report",kpiKey: "smsSent",        kpiLabel: "sent",      color: "bg-blue-100",    textColor: "text-blue-700",    borderHover: "hover:border-blue-400" },
      ...
      { label: "Social Media",      sub: "All social channels",      icon: Share2,         href: "/admin/social-media",         kpiKey: "socialPosts",    kpiLabel: "channels",  color: "bg-sky-100",     textColor: "text-sky-700",     borderHover: "hover:border-sky-400" },
      { label: "Omnichannel Inbox", sub: "Unified message inbox",    icon: Inbox,          href: "/admin/inbox",                kpiKey: "inboxCount",     kpiLabel: "unread",    color: "bg-indigo-100",  textColor: "text-indigo-700",  borderHover: "hover:border-indigo-400" },
      ...
      { label: "Communication Ctr", sub: "Templates & channels",     icon: MessageCircle,  href: "/admin/communication-center", kpiKey: "commCount",      kpiLabel: "templates", color: "bg-rose-100",    textColor: "text-rose-700",    borderHover: "hover:border-rose-400" },
      { label: "Notification Health",sub:"Delivery status & logs",   icon: Bell,           href: "/admin/notification-health",  kpiKey: "notifHealth",    kpiLabel: "monitored", color: "bg-pink-100",    textColor: "text-pink-700",    borderHover: "hover:border-pink-400" },
      { label: "Website CMS",       sub: "Public pages & content",   icon: Globe,          href: "/admin/settings",             kpiKey: "cmsPages",       kpiLabel: "pages",     color: "bg-teal-100",    textColor: "text-teal-700",    borderHover: "hover:border-teal-400" },
      { label: "Mobile App",        sub: "App configuration",        icon: LayoutGrid,     href: "/admin/api-settings",         kpiKey: "appUsers",       kpiLabel: "users",     color: "bg-cyan-100",    textColor: "text-cyan-700",    borderHover: "hover:border-cyan-400" },
    ],
  },
  // ── 8. Reports & Analytics ──────────────────────────────────────────────────
  {
    ...
    items: [
      { label: "Reports Center",    sub: "Operational reports",      icon: BarChart2,      href: "/admin/reports",              kpiKey: "reportCount",    kpiLabel: "reports",   color: "bg-slate-100",   textColor: "text-slate-700",   borderHover: "hover:border-slate-400" },
      { label: "Business Intel",    sub: "Trends & BI dashboard",    icon: TrendingUp,     href: "/admin/bi",                   kpiKey: "biCount",        kpiLabel: "metrics",   color: "bg-gray-100",    textColor: "text-gray-700",    borderHover: "hover:border-gray-400" },
  ...
  // ── 10. Administration & Security ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Permissions",       sub: "Role permission matrix",   icon: ShieldCheck,    href: "/admin/permissions",          kpiKey: "roles",          kpiLabel: "roles",     color: "bg-rose-100",    textColor: "text-rose-700",    borderHover: "hover:border-rose-400" },
      { label: "Audit Logs",        sub: "All system activity",      icon: ClipboardList,  href: "/admin/audit-logs",           kpiKey: "auditLogs",      kpiLabel: "events",    color: "bg-orange-100",  textColor: "text-orange-700",  borderHover: "hover:border-orange-400" },
      { label: "Activity Logs",     sub: "User activity stream",     icon: Activity,       href: "/admin/activity-logs",        kpiKey: "activityLogs",   kpiLabel: "events",    color: "bg-amber-100",   textColor: "text-amber-700",   borderHover: "hover:border-amber-400" },
      { label: "Security",          sub: "System health & alerts",   icon: Lock,           href: "/admin/security",             kpiKey: "securityEvents", kpiLabel: "alerts",    color: "bg-yellow-100",  textColor: "text-yellow-700",  borderHover: "hover:border-yellow-400" },
      ...
      { label: "Backup",            sub: "Data backups & restore",   icon: Archive,        href: "/admin/backups",              kpiKey: "backups",        kpiLabel: "backups",   color: "bg-green-100",   textColor: "text-green-700",   borderHover: "hover:border-green-400" },
      { label: "API Manager",       sub: "API keys & endpoints",     icon: Code2,          href: "/admin/api-settings",         kpiKey: "apiKeys",        kpiLabel: "keys",      color: "bg-teal-100",    textColor: "text-teal-700",    borderHover: "hover:border-teal-400" },
      { label: "Integrations",      sub: "Third-party connections",  icon: Plug,           href: "/admin/integrations",         kpiKey: "integrations",   kpiLabel: "connected", color: "bg-cyan-100",    textColor: "text-cyan-700",    borderHover: "hover:border-cyan-400" },
      { label: "Business Settings", sub: "Company configuration",    icon: Settings2,      href: "/admin/settings",             kpiKey: "settings",       kpiLabel: "modules",   color: "bg-sky-100",     textColor: "text-sky-700",     borderHover: "hover:border-sky-400" },
