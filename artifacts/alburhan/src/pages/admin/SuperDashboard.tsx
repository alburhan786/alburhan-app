...
const MODULES: { section: string; color: string; items: Module[] }[] = [
  ...
  // ── 7. Communication & Automation ───────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: "Notification Dashboard",   sub: "Delivery status & logs",       icon: Bell,           href: "/admin/notification-health",  kpiKey: "notifHealth", kpiLabel: "monitored", color: "bg-pink-100",    textColor: "text-pink-700",    borderHover: "hover:border-pink-400" },
