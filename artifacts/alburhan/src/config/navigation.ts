  ...
  return [
    ...
    // ── 7. MARKETING ─────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        { icon: Share2,        label: "Social Integration Hub",          href: "/admin/social-hub",              require: ["settings",  "view"], aliases: ["social hub", "integration hub", "social status", "16 channels", "facebook", "instagram", "lead ads", "social overview"] },
