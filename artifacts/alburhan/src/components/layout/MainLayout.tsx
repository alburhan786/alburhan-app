...
import { Phone, LogOut, User as UserIcon, Menu } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-primary-foreground/80">
                <li><Link href="/packages" className="hover:text-accent transition-colors">Our Packages</Link></li>
                <li><Link href="/about" className="hover:text-accent transition-colors">About Us</Link></li>
                <li><Link href="/contact" className="hover:text-accent transition-colors">Contact Support</Link></li>
                <li><Link href="/login" className="hover:text-accent transition-colors">Customer Login</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-primary-foreground/80">
                <li className="flex items-start gap-3">
                  <span className="text-accent mt-1">📍</span> 123 Heritage Lane, Mumbai, India
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent mt-1">📞</span> +91 98765 43210
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent mt-1">✉️</span> bookings@alburhan.com
                </li>
              </ul>
            </div>
          </div>
